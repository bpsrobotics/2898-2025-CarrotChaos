...
class PIDFF(PIDConstants : PIDConstants, FFConstants : SimpleMotorFeedForwardConstants) {
    ...
    var setpoint : Double get() = PID.setpoint
                        set(value) {PID.setpoint = value}
    /** Returns the calculated PID value given [measurement], plus the calculated FeedForwardValue given the [setpoint]
