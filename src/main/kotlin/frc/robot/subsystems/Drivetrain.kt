...
//    }
    ...
    val pose get() = Pose2d(swerveDrive.pose.x, swerveDrive.pose.y, swerveDrive.pose.rotation)
    ...
    fun getTargetSpeeds(
        ...
        return swerveDrive.swerveController.getTargetSpeeds(vForward, vSide, angle.radians, heading.radians, maximumSpeed)
    }
    ...
    fun getTargetSpeeds(
        ...
        return swerveDrive.swerveController.getTargetSpeeds(vForward, vSide, headingX, headingY, heading.radians, maximumSpeed)
    }
