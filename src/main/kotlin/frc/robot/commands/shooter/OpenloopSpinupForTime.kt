...
/**
 * Runs both shooter motors at the given [percent] for [time], without running the [Shooter.gateMotor], in order to ensure the shooter is spinning at a fast speed before carrots are fed
